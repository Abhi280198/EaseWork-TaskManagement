        ...
        <div class="mdk-header-layout__content">
                        ...
                        <div id="demo" class="w3-dropdown-content w3-bar-block w3-card" style="right: 0; width: 400px; height: 450px; border-color: black; background-color: black; border-radius: 2px;">
                            <center><div class="modal-content" style= " margin: 10px; overflow-y: auto; border-radius: 2px; height: 430px;">
                                ...
                                <div>
                                    ...
                                    -Effortlessly plan your next adventure including your packing list, budget, hotel accommodations, foods to eat, and sights to see. Get all the vacation logistics onto a single board so you can focus on the important part: Relaxing.
                                    - Make a list with items you need to do before your trip starts: packing lists, passport updates, booking confirmations, etc.
                                    - When people inevitably give you recommendations, keep them all in “Things To Do/Places to Eat” lists so you don’t forget.
         ...
         <!-- start create board link -->
            <div class="w3-bar w3-border w3-black">
                <div class="w3-bar-item" style="margin-left: 400px; border: black;">This is a Personal Template.</div>
                            ...
                            <div class="card-body p-2">
                                <div class="trello-board__tasks-list card-list" id="trello-tasks-3">
                                    ...
                                    <div class="trello-board__tasks-item card shadow-none border" data-toggle="modal" data-target="#exampleModal" onclick="cardopenForm()">
                                        <div class="p-3">
                                            <p class="m-0 d-flex align-items-center">
                                                <strong>Some specific resturant</strong> 
                                                <span class="badge badge-success ml-auto">Label</span>                                               
                                            </p>
                                            <br>
                                            <p class="d-flex align-items-center mb-2">
